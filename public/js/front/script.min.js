!function (i) {
    ...
    if (i(window).width() > 992) {
        ...
        i(window).on("scroll", {previousTop: 0}, function () {
            ...
            s < this.previousTop ? s > 0 && i("#mainNav").hasClass("is-fixed") ? i("#mainNav").addClass("is-visible") : i("#mainNav").removeClass("is-visible is-fixed") : s > this.previousTop && ( s > o && !i("#mainNav").hasClass("is-fixed") && i("#mainNav").addClass("is-fixed is-visible")), this.previousTop = s
        })
    }
}(jQuery);